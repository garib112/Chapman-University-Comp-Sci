...
void DNAreader::readDNAFile(string fileName){
	...
	{
		ofstream outputFile("MeganYu.txt", ios_base::app);
...
void DNAreader::probNucleotide() {
	ofstream outputFile("MeganYu.txt", ios_base::app);//outputs the probability of each nucleotide occuring given the total number of nucleotides in the file
...
void DNAreader::probBigram() {
	ofstream outputFile("MeganYu.txt", ios_base::app); //outputting the probability of each bigram occuring given the total bigrams in the file
